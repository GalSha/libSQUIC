...
// cover the changes slightly improved version partially using OpenMP
void SQUIC::BlockCoordinateDescentUpdate(const double Lambda, SparseMatrix *D,
                                         integer *idx, integer *idxpos,
                                         double *val, index_pair *activeSet,
                                         integer first, integer last,
                                         double &l1norm_D, double &diffD) {
  /*
